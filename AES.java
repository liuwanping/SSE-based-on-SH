...
//		print();
	...
	public static void encrypt_index(TrapdoorAndDataIDs[][][] index)
	{
		...
		for(int l=0;l<index.length;l++)
		{
			for(int a=0;a<index[l].length;a++)
			{
				...
				{
					if(index[l][a][b].trapdoor!=null)
					{
						index[l][a][b].trapdoor=new String(aes.cipher(index[l][a][b].trapdoor.getBytes()));
					}
	...
	public static String encrypt_trapdoor(int hashkey)
	{
		byte[] keys = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
				0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17 };
		AES aes = new AES(KeySize.Bits192, keys);
...
//		int a=1;
//		int b=1;
//		System.out.println(encrypt_trapdoor(a));
//		System.out.println(encrypt_trapdoor1(b));
//	}
//	public static void main(String[] args){
//		byte[] keys = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
//				0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17 };
...
//		String plainText = Integer.toString(a);
//		String plainText2 = Integer.toString(a2);
//		byte[] cipherText = aes.cipher(plainText.getBytes());
//		byte[] cipherText2 = aes.cipher(plainText2.getBytes());
//		
...
//		//if(Arrays.equals(cipherText, cipherText2))
//		if(s.equals(s1))
//		{
//			System.out.println("可以等");
...
//			System.out.println(cipherText2.toString());
//		}
//			
//		
...
//		for(int i = 0;i< 16;i++){
//			if((cipherText[i]&0xff) > 0x0f)
//				m2.append(String.format("%x", cipherText2[i]));
//			else
//				m2.append(String.format("0%x", cipherText2[i]));
//			m2.append(" ");
//		}
//		System.out.println("cipherText:"+m2);
//		
//		if(m.equals(m2))
...
//		byte[] ret2 = aes.invCipher(cipherText2);
//		String val = new String(ret);
//		String val2 = new String(ret2);
//		System.out.println("invCipher cipherText : "+val.trim());
//		System.out.println("invCipher cipherText : "+val2.trim());
//		
//	}
//	
}
